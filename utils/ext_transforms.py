...
class ExtRandomScale(object):
    ...
    def __call__(self, img, lbl):
        ...
        return F.resize(img, target_size), F.resize(lbl, target_size, InterpolationMode.NEAREST)
...
class ExtResize(object):
    ...
    def __call__(self, img, lbl):
        ...
        Returns:
            PIL Image: Rescaled image.
        """
        return F.resize(img, self.size), F.resize(lbl, self.size, InterpolationMode.NEAREST)
