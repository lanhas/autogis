...
def main(config):
    svname = args.name
    if svname is None:
        svname = 'villageSP_clss-' + config['model_args']['encoder']
    ...
    if config.get('fs_dataset'):
        ...
        fs_sampler = CategoriesSampler(
            fs_dataset.label, eval_fs_args['train_batches'],
            eval_fs_args['n_way'],
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', default='../configs/train_villageSP_clss.yaml')
